        ...
        >
          ...
          <template v-for="(ft, idx) in formTemplates">
            <el-card
              ...
              class="ft-card"
            >
             <div class="ft-title">#{{ idx + 1 }} {{ ft.title }}</div>
...
import { addWindowResizeHandler } from "@/vform/utils/util"
import i18n from "@/vform/utils/i18n"
import axios from "axios"

import ftImg1 from '@/vform/assets/ft-images/t1.png'
import ftImg2 from '@/vform/assets/ft-images/t2.png'
import ftImg3 from '@/vform/assets/ft-images/t3.png'
import ftImg4 from '@/vform/assets/ft-images/t4.png'
import ftImg5 from '@/vform/assets/ft-images/t5.png'
import ftImg6 from '@/vform/assets/ft-images/t6.png'
import ftImg7 from '@/vform/assets/ft-images/t7.png'
import ftImg8 from '@/vform/assets/ft-images/t8.png'
...
export default {
  ...
  mounted() {
    ...
    this.scrollerHeight = window.innerHeight - 86 + 'px'
...
.panel-container {
  ...
  ::v-deep .container-widget-item,.field-widget-item {
