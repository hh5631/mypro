  ...
  <div class="toolbar-container">
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="getFormData" size="small">{{
          i18nt('designer.hint.getFormData')
        }}</el-button>
        <el-button type="primary" @click="resetForm" size="small">{{
          i18nt('designer.hint.resetForm')
        }}</el-button>
        <el-button type="primary" @click="setFormDisabled" size="small">{{
          i18nt('designer.hint.disableForm')
        }}</el-button>
        <el-button type="primary" @click="setFormEnabled" size="small">{{
          i18nt('designer.hint.enableForm')
        }}</el-button>
        <el-button type="" @click="showPreviewDialogFlag = false" size="small">{{
    ...
    >
      ...
      ></code-editor>
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="doJsonImport" size="small">
          {{ i18nt('designer.hint.import') }}</el-button
        >
        <el-button @click="showImportJsonDialogFlag = false" size="small">
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        >
        <el-button @click="saveFormJson" size="small">{{
          i18nt('designer.hint.saveFormJson')
        }}</el-button>
        <el-button type="" @click="showExportJsonDialogFlag = false" size="small">
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        >
        <el-button @click="saveVueCode" size="small">{{
          i18nt('designer.hint.saveVueCode')
        }}</el-button>
        <el-button @click="saveHtmlCode" size="small">{{
          i18nt('designer.hint.saveHtmlCode')
        }}</el-button>
        <el-button type="" @click="showExportCodeDialogFlag = false" size="small">
          {{ i18nt('designer.hint.closePreview') }}</el-button
        >
      </div>
    </el-dialog>
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        >
        <el-button @click="saveFormData" size="small">{{
          i18nt('designer.hint.saveFormData')
        }}</el-button>
        <el-button type="" @click="showFormDataDialogFlag = false" size="small">
          {{ i18nt('designer.hint.closePreview') }}</el-button
        >
      </div>
    </el-dialog>
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        >
        <el-button @click="saveV2SFC" size="small">{{
          i18nt('designer.hint.saveVue2SFC')
        }}</el-button>
        <el-button @click="saveV3SFC" size="small">{{
          i18nt('designer.hint.saveVue3SFC')
        }}</el-button>
        <el-button type="" @click="showExportSFCDialogFlag = false" size="small">
          {{ i18nt('designer.hint.closePreview') }}</el-button
        >
      </div>
    </el-dialog>
...
import { generateCode } from "@/vform/utils/code-generator";
import { genSFC } from "@/vform/utils/sfc-generator";
import loadBeautifier from "@/vform/utils/beautifierLoader";
