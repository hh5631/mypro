  ...
  <div>
      ...
      <el-collapse v-model="formActiveCollapseNames" class="setting-collapse">
        ...
        >
          ...
          <el-form-item label="onFormValidate">
            <el-button type="info" icon="el-icon-edit" size="small" plain round @click="editFormEventHandler('onFormValidate')">
              {{i18nt('designer.setting.addEventHandler')}}</el-button>
          </el-form-item>
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="showFormEventDialogFlag = false" size="small">
          {{ i18nt('designer.hint.cancel') }}</el-button
        >
        <el-button type="primary" @click="saveFormEventHandler" size="small">
    ...
    >
      ...
      ></code-editor>
      <div slot="footer" class="dialog-footer">
        <el-button @click="showEditFormCssDialogFlag = false" size="small">
          {{ i18nt('designer.hint.cancel') }}</el-button
        >
        <el-button type="primary" @click="saveFormCss" size="small">
          {{ i18nt('designer.hint.confirm') }}</el-button
        >
      </div>
    </el-dialog>
    ...
    >
      ...
      ></code-editor>
      <div slot="footer" class="dialog-footer">
        <el-button @click="showEditFunctionsDialogFlag = false" size="small">
          {{ i18nt('designer.hint.cancel') }}</el-button
        >
        <el-button type="primary" @click="saveGlobalFunctions" size="small">
          {{ i18nt('designer.hint.confirm') }}</el-button
        >
      </div>
    </el-dialog>
...
import { deepClone, insertCustomCssToHead, insertGlobalFunctionsToHtml } from "@/vform/utils/util"
...
::v-deep .setting-form .el-form-item__label{
  //修复左对齐和间距
 text-align: left;
 margin-top: 14px;
}
