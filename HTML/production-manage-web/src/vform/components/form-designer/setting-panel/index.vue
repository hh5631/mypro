<template>
  <el-container class="panel-container">
    <el-tabs :active-name="activeTab" class="indent-left-margin">
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="showWidgetEventDialogFlag = false" size="small">
          {{ i18nt("designer.hint.cancel") }}</el-button
        >
        <el-button type="primary" @click="saveEventHandler" size="small">
...
export default {
  ...
  mounted() {
    ...
    this.scrollerHeight = window.innerHeight - 106 - 48 + "px";
...
::v-deep .el-tabs__nav-scroll{
 ...
 ::v-deep .el-tabs__nav-scroll :nth-child(3){
    margin-left: 35px;
  }
</style>
