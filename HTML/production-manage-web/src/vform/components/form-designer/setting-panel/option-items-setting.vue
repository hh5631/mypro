<template>
  <div class="option-items-pane">
    ...
    <div v-if="selectedWidget.type === 'cascader'">
      <el-button type="text" @click="importCascaderOptions" size="small">{{
        i18nt('designer.setting.importOptions')
      }}</el-button>
      <el-button type="text" @click="resetDefault" size="small">{{
    ...
    <div
      ...
      "
    >
      <el-button type="text" @click="addOption" size="small">{{
        i18nt('designer.setting.addOption')
      }}</el-button>
      <el-button type="text" @click="importOptions" size="small">{{
        i18nt('designer.setting.importOptions')
      }}</el-button>
      <el-button type="text" @click="resetDefault" size="small">{{
        i18nt('designer.setting.resetDefault')
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button size="small" type="" @click="showImportDialogFlag = false">{{
    ...
    >
      ...
      ></code-editor>
      <div slot="footer" class="dialog-footer">
        <el-button size="small" type="primary" @click="saveCascaderOptions">{{
          i18nt('designer.hint.confirm')
        }}</el-button>
        <el-button
          size="small"
...
export default {
  ...
  components: {
    Draggable,
    //CodeEditor: () => import('@/vform/components/code-editor/index'),
    CodeEditor,
  },
  props: {
    designer: Object,
