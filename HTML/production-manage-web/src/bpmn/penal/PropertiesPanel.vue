  ...
  >
    <el-collapse v-model="activeTab">
      ...
      >
        ...
        <element-task :id="elementId" :type="elementType" :multi-type="multiType"/>
      </el-collapse-item>
      <el-collapse-item
        name="multiInstance"
        v-if="elementType.indexOf('Task') !== -1"
...
export default {
  ...
  methods: {
    ...
    initFormOnChanged(element) {
      ...
      //         ----------
      //         `);
      this.isEvent = activatedElement.type !== "bpmn:Process";
