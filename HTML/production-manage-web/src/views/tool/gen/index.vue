<template>
  <div class="app-container">
    ...
    />
    <!-- 预览界面 -->
    <el-dialog :title="preview.title" :visible.sync="preview.open" width="80%" append-to-body class="scrollbar">
  ...
  methods: {
    ...
    handleGenTable(row) {
      ...
      if (row.genType === '1') {
        ...
        this.$download.zip('/code/gen/batchGenCode?tables=' + tableNames, 'jri')
      }
    },
    /** 同步数据库操作 */
    handleSynchDb(row) {
