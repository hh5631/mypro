  ...
  <div class="approval-process">
    ...
    <div v-show="activeIndex==0">
      <el-table ref="tableData" border :data="processData" class="table-class" highlight-current-row>
        ...
        <el-table-column prop="message" :show-overflow-tooltip="true" label="处理意见" align="center" />
      </el-table>
    </div>
    <div v-show="activeIndex==1" style="height:600px;width: 100%;">
      <process-designer
        ref="processDesigner"
      />
    </div>
...
export default {
  ...
  methods: {
    getList() {
      ...
      if (checkPermi(['assetManagement:comments:list'])) {
