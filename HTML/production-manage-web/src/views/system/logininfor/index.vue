  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :model="queryParams" :inline="true" label-width="68px">
      ...
      <el-form-item>
        ...
        <el-button type="primary" class="search-btn" icon="el-icon-search" size="small" @click="handleQuery">搜索</el-button>
      </el-form-item>
    </el-form>
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/logininfor/export', this.ids, `logininfor_${new Date().getTime()}.xlsx`)
    }
  }
}
</script>
